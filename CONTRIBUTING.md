# Contributing to algorithms for democracy
...
- [Contributing to algorithms for democracy](#contributing-to-algorithms-for-democracy)
...
```bash
git clone https://github.com/brooks-code/algorithms-for-democracy.git
cd algorithms-for-democracy
```
